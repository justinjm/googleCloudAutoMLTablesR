...
```{r}
table_colspecs <- gcat_get_column_specs(  
  projectId = projectId,
  location = gcat_location,
  datasetId = datasetId,
...
Then the second function to list more details:
...
gcat_set_label(
  ...
  datasetId = datasetId,
  tableSpecId = "7338035050660757504",
  label_column_name = "V16" # projects/736862006196/locations/us-central1/datasets/TBL4800700863335104512/tableSpecs/7338035050660757504/columnSpecs/7181143537470144512
  )
