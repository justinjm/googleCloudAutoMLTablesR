...
```{r}
# rjson::toJSON(Dataset(displayName = "test_02"))
# rjson::toJSON(Dataset(displayName = "test_02"))
datasetMetadata <- Dataset(displayName = "test_02")

# Dataset_json <- rjson::toJSON(Dataset)
# rjson::fromJSON(Dataset_json)
gcat_create_dataset(Dataset = datasetMetadata)
```
