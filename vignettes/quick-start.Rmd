...
## Configure your own Google Cloud Platform project 
...
Then we can invoke the [predict API ](https://googleapis.dev/python/automl/latest/gapic/v1beta1/tables.html#google.cloud.automl_v1beta1.tables.tables_client.TablesClient.predict) like so: 
