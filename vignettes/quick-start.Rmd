...
```{r}
# TODO - @justinjm - consider omitting since only needed for back-end API calls
# table_specs_list <- gcat_list_table_specs(
#   projectId = projectId,
#   locationId = location,
#   displayName = dataset_display_name 
# )
...
```{r}
gcat_get_column_spec(name = "projects/736862006196/locations/us-central1/datasets/TBL4800700863335104512/tableSpecs/7338035050660757504/columnSpecs/7181143537470144512")
```
